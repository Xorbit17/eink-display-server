...
from dashboard.views.display_service import DisplayDashboardView, DisplayVariantView, DisplayBootScreenView, DisplayButtonController, DisplayPollController, BootstrapController
...
urlpatterns = [
    ...
    path("api/display/splash_screen", DisplayBootScreenView.as_view(), name="display-bootstrap"),
    path('api/display/button', DisplayButtonController.as_view(), name="display-button"),
    path('api/display/poll', DisplayPollController.as_view(), name="display-poll"),
    path('api/display/bootstrap', BootstrapController.as_view(), name="display-bootstrap")
]
