# Generated by Django 5.2.6 on 2025-09-21 14:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_source_dir', models.CharField(default='~/Pictures', help_text='Folder where to find source images to classify and regenerated', max_length=255)),
                ('image_generation_dir', models.CharField(default='~/Pictures/generated', help_text='Folder where to output generated images.', max_length=255)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('palette', models.CharField(choices=[('NATIVE', 'Native'), ('EXTENDED', 'Extended'), ('NATIVE_SHADED', 'Shaded'), ('NATIVE_EXTENDED_SHADED', 'Shaded + Extended'), ('NATIVE_EXTENDED_SHADED_SKIN', 'Shaded + Extended'), ('NATIVE_SKIN', 'Native + Skin Tones'), ('NATIVE_SKIN_EXTENDED', 'Extended + Native + Skin Tones'), ('BLACK_WHITE', 'Black-white'), ('WOODCUT', 'Woodcut'), ('WOOD_EXTENDED', 'Wood extended')], default='NATIVE', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(default='Europe/Brussels', max_length=64)),
                ('default_mode', models.CharField(choices=[('news', 'Newspaper'), ('photo', 'Photo'), ('dashboard', 'Dashboard'), ('boot', 'Boot screen')], default=dashboard.constants.Mode['PHOTO'], max_length=16)),
                ('override_mode', models.CharField(choices=[('news', 'Newspaper'), ('photo', 'Photo'), ('dashboard', 'Dashboard'), ('boot', 'Boot screen')], default=None, max_length=16, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('news', 'Newspaper'), ('photo', 'Photo'), ('dashboard', 'Dashboard'), ('boot', 'Boot screen')], default=dashboard.constants.Mode['PHOTO'], max_length=16)),
                ('active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
