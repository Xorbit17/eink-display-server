    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_image_dir', models.CharField(default='/app/input', help_text='Base directory where source images are stored.', max_length=512)),
                ('generate_image_dir', models.CharField(default='/app/generate', help_text='Directory for generated artifacts.', max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('artstyle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.artstyle')),
